...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-background via-background to-accent/5 p-3 sm:p-4 md:p-6">
      ...
      <div
        className={cn(
          'relative z-10 w-full max-w-md rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 glass-form mx-2 sm:mx-0 overflow-y-auto max-h-[calc(100vh-8rem)]',
          'animate-fade-in'
        )}
      >
        <h1 className="text-xl sm:text-2xl font-bold text-foreground mb-1">Create an account</h1>
        <p className="text-xs sm:text-sm text-muted-foreground mb-4 sm:mb-6">
          Get started with TaskFlow – manage tasks, teams, and projects in one place.
        </p>
